...
// const model = genAI.getGenerativeModel({ model: "gemma-3-12b-it" }); // Your chosen model

// // --- Newly Added Code Block 1: Predefined Responses ---
// // Define your specific questions and answers
// const predefinedResponses = new Map([
//   ["what service do you provide?", "We have several services such as AI-powered chat assistants, content generation for marketing, data analysis insights, and personalized learning modules. How can I assist you with these services?"],
//   ["what are your working hours?", "Our support team is available Monday to Friday, from 9 AM to 5 PM Eastern Time."],
//   ["how can I contact support?", "You can contact our support team by emailing support@example.com or calling us at 1-800-123-4567."]
//   // Add more specific questions and answers here
// ]);

// // Function to normalize user input for comparison (e.g., lowercasing, removing punctuation)
// function normalizePrompt(prompt) {
//     return prompt.toLowerCase().replace(/[?.,!']/g, '').trim();
// }
// // --- End Newly Added Code Block 1 ---
...
//   const { prompt, userInfo, sessionId } = req.body; // Note: sessionId added for future multi-turn context if you use it

//   if (!prompt) {
//     return res.status(400).json({ error: 'Prompt is required' });
//   }

//   // --- Newly Added Code Block 2: Check for Predefined Responses ---
//   const normalizedPrompt = normalizePrompt(prompt);

//   // Check for predefined responses first
//   if (predefinedResponses.has(normalizedPrompt)) {
//     console.log(`Matched predefined response for: "${prompt}"`);
//     return res.json({ text: predefinedResponses.get(normalizedPrompt) });
//   }
//   // --- End Newly Added Code Block 2 ---

//   // --- Remainder of the code (only runs if no predefined response) ---
//   // If no predefined response, proceed with Gemini
...
//     console.log("Generated text successfully via Gemini."); // Updated log message
//     res.json({ text: text });
//   } catch (error) {
...
// // For chat history, you'd integrate the sessionId logic around the `model.startChat()` and `chat.sendMessage()`
// // If you want predefined answers to also work within a multi-turn chat, you'd apply the same `predefinedResponses.has` check
// // *before* calling `chat.sendMessage()`.
